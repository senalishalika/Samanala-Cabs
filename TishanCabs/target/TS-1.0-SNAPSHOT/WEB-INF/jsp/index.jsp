...
<body class="home">
	...
	<header id="head">
		<div class="container">
			<div class="row">
				<h1 class="lead">A Reliable way to travel</h1>
	...
	<div class="container text-center">
		...
		<p class="text-muted">
			WHO WE ARE
Tishan Cabs (Pvt) Ltd based in Colombo district and presently operates for entire Colombo district. We are having three wheel and Nano Car. We will be expanding our service to other districts soon. We provide the best service possible to our clients that will make their journey pleasant. Our taxi booking system, arguably one of the best in the Sri Lanka, wirelessly connects our taxis using the latest technology. We are committed to developing innovative transport solutions across our operations and making every trip on board an enjoyable experience for commuters.
		</p>
	</div>
	<!-- /Intro-->
